<template>
  <mdb-container>
    ...
    <section class="demo-section">
      ...
      <!-- Custom styles -->
      <section>
        <form class="needs-validation was-validated" novalidate @submit="checkForm">
          <div class="form-row">
            <div class="col-md-4 mb-3">
              <label for="validationCustom01">First name</label>
              <input type="text" class="form-control:invalid" id="validationCustom01" placeholder="First name" value="Mark" required>
